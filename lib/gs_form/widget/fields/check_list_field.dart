...
import 'package:data_forms/gs_form/enums/required_check_list_enum.dart';
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      if (item.isSelected) {
                        ...
                        widget.valueObject.removeWhere(
                            (element) => element.data == item.data);
                      }
                      stateManager.set(widget.model.tag,
                          widget.valueObject); // Update the model
                    ...
                    child: Padding(
                      ...
                      child: CheckBoxItem(widget.filteredItems[index],
